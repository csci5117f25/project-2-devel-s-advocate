...
<template>
  <div id="main-container" class="flex flex-col mt-32">
    <div class="flex flex-col items-center">
      <h1 class="text-3xl text-center font-bold p-4">Oops!</h1>
    ...
    <div id="tired-animation" class="text-center border border-black h-75 rounded-xl m-4">
      Tired Animation
    </div>
  </div>
</template>
